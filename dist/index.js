...
/* harmony export */   "default": () => (/* binding */ AsciiRenderer)
/* harmony export */ });
/* harmony import */ var _Game__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Game */ "./src/Game.ts");

const repeat = __webpack_require__(/*! lodash/repeat.js */ "./node_modules/lodash/repeat.js");
const chunk = __webpack_require__(/*! lodash/chunk.js */ "./node_modules/lodash/chunk.js");
function span(text, classes) {
    return `<span class="${classes}">${text}</span>`;
}
function directionToArrow(direction) {
    return {
        [_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Up]: '↑',
        [_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Down]: '↓',
        [_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Left]: '←',
        [_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Right]: '→'
    }[direction];
}
class AsciiRenderer {
    constructor(game, pre, classes = {
        apple: 'text-red-600',
        head: 'text-green-700',
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ConsoleRenderer)
/* harmony export */ });
const formatCoords = ({ x, y }) => {
    return `[${String(x).padStart(2, '0')} ${String(y).padStart(2, '0')}]`;
};
class ConsoleRenderer {
    constructor(game, output = text => console.log(text)) {
        this.output = output;
        this.render(game.state);
        game.events.on('afterTick', state => this.render(state));
    ...
    render({ snake, apple, score, ticks }) {
...
const matches = __webpack_require__(/*! lodash/matches.js */ "./node_modules/lodash/matches.js");
const isMatch = __webpack_require__(/*! lodash/isMatch.js */ "./node_modules/lodash/isMatch.js");
var Direction;
(function (Direction) {
    Direction["Up"] = "\u2B06\uFE0F";
    Direction["Down"] = "\u2B07\uFE0F";
...
function createSprite() {
    let sprite = {
        ...
        map: {
            apple: [3, 2],
            [`head${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Up}`]: [0, 0],
            [`head${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Down}`]: [0, 1],
            [`head${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Left}`]: [0, 2],
            [`head${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Right}`]: [0, 3],
            [`tail${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Up}`]: [1, 0],
            [`tail${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Down}`]: [1, 1],
            [`tail${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Left}`]: [1, 2],
            [`tail${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Right}`]: [1, 3],
            [`${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Up}${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Left}`]: [2, 0],
            [`${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Up}${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Right}`]: [2, 1],
            [`${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Down}${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Left}`]: [2, 2],
            [`${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Down}${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Right}`]: [2, 3],
            [`${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Left}${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Up}`]: [2, 3],
            [`${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Right}${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Up}`]: [2, 2],
            [`${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Left}${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Down}`]: [2, 1],
            [`${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Right}${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Down}`]: [2, 0],
            [`${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Up}${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Up}`]: [3, 0],
            [`${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Down}${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Down}`]: [3, 0],
            [`${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Left}${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Left}`]: [3, 1],
            [`${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Right}${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Right}`]: [3, 1],
        }
    };
...
class SpriteRenderer {
    ...
    createBackgroundImage() {
        ...
        for (let i = 1; i < this.rows + 3; i++) {
            ...
            this.drawSprite(`${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Up}${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Up}`, { x: this.cols + 1, y: i });
        }
        // horizontal border
        for (let i = 1; i < this.cols + 1; i++) {
            this.drawSprite(`${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Right}${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Right}`, { x: i, y: 0 });
            this.drawSprite(`${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Right}${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Right}`, { x: i, y: 2 });
            this.drawSprite(`${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Right}${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Right}`, { x: i, y: this.rows + 3 });
        }
        this.ctx.clearRect((this.cols + 1) * sprite.size, 2 * sprite.size, sprite.size, sprite.size);
        this.drawSprite(`tail${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Down}`, { x: this.cols + 1, y: 2 });
        // border corners
        this.drawSprite(`${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Up}${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Right}`, { x: 0, y: 0 });
        this.drawSprite(`${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Up}${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Left}`, { x: this.cols + 1, y: 0 });
        this.drawSprite(`${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Down}${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Left}`, { x: this.cols + 1, y: 2 });
        this.drawSprite(`${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Down}${_Game__WEBPACK_IMPORTED_MODULE_0__.Direction.Right}`, { x: 0, y: this.rows + 3 });
    ...
    drawSprite(type, position) {
        this.ctx.drawImage(sprite.img, ...sprite.map[type], sprite.size, sprite.size, position.x * sprite.size, position.y * sprite.size, sprite.size, sprite.size);
    }
    drawStats({ score, ticks, direction }) {
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _AsciiRenderer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AsciiRenderer */ "./src/AsciiRenderer.ts");
/* harmony import */ var _ConsoleRenderer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ConsoleRenderer */ "./src/ConsoleRenderer.ts");
/* harmony import */ var _Game__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Game */ "./src/Game.ts");
/* harmony import */ var _SpriteRenderer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./SpriteRenderer */ "./src/SpriteRenderer.ts");




window.Game = _Game__WEBPACK_IMPORTED_MODULE_2__.default;
window.ConsoleRenderer = _ConsoleRenderer__WEBPACK_IMPORTED_MODULE_1__.default;
window.AsciiRenderer = _AsciiRenderer__WEBPACK_IMPORTED_MODULE_0__.default;
window.SpriteRenderer = _SpriteRenderer__WEBPACK_IMPORTED_MODULE_3__.default;
